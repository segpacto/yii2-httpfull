...
class Request
{
    ...
    {
        $user_agent = 'User-Agent: httpfull/' . httpfull::VERSION . ' (cURL/';
        $curl = \curl_version();
    ...
    private function _serializePayload($payload)
    {
        ...
        return Httpfull::get($this->content_type)->serialize($payload);
    }
    ...
    {
        return self::initialize(Http::GET)->uri($uri)->mime($mime);
    }
    ...
    {
        return self::initialize(Http::PUT)->uri($uri)->body($payload, $mime);
    }
    ...
    {
        return self::initialize(Http::PATCH)->uri($uri)->body($payload, $mime);
    }
    ...
    {
        return self::initialize(Http::DELETE)->uri($uri)->mime($mime);
    }
    ...
    {
        return self::initialize(Http::HEAD)->uri($uri);
    }
    ...
    {
        return self::initialize(Http::OPTIONS)->uri($uri);
    }
}
